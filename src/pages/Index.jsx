...
import { Container, FormControl, FormLabel, Input, Select, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalBody, ModalCloseButton, useDisclosure, VStack, Box, Heading } from "@chakra-ui/react";
...
const Index = () => {
  ...
  return (
    <>
      <Header />
      <Container centerContent maxW="container.md" py={10} boxShadow="xl" border="1px" borderColor="gray.200">
